...
const Home = () => {
  ...
  return (
    <motion.div
      ...
      style={{
        minHeight: 'calc(100vh - 76px)', // Phụ thuộc vào chiều cao Navbar
    ...
    >
      <div className="container text-center">
        ...
        >
          Hơn 500+ quán cà phê vệ tinh phù hợp cho sinh viên làm việc, học nhóm với wifi mạnh và ổ cắm mọi nơi.
        </motion.p>
